...
urlpatterns = [
    ...
    path('summaries/<int:pk>/edit/', views.summary_edit, name='summary_edit'),           # ✅ NEW
    path('summaries/send-selected/', views.summary_send_selected, name='summary_send_selected'),  # ✅ NEW
